...
## 1. Adjust the Dark Mode Strategy
...
> [!NOTE]
> For Next.js users, you will need to set [suppressHydrationWarning](https://nextjs.org/docs/messages/react-hydration-error#solution-3-using-suppresshydrationwarning) to `true` on the root `<html>` element. This will suppress hydration warnings for the `data-mode` attribute.
